        ...
        <div class="nav">
            <div class="wrap">
                ...
                <div class="navItem">
                    ...
                    <router-link to="/index/intro" tag="li">产品介绍</router-link>
                    <router-link to="/index/join" tag="li">招商加盟</router-link>
                    <router-link to="/index/backstage" tag="li">商家后台</router-link>
                    <router-link to="/index/news" tag="li">新闻资讯</router-link>
                    <router-link to="/index/about" tag="li">关于我们</router-link>
                    <router-link to="/index/taobao" tag="li">淘宝商城</router-link>
                </div>
            </div>
        </div>
        <div class="main">
...
export default {
  ...
  data() {
    return {
      str: "hello"
      // img1:require('../asset/img/logo.png')
    };
  },
  methods: {
    swit($event) {
...
.nav .navItem li:nth-last-of-type(1) {
  padding-right: 0px;
}
